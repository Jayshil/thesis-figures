...
from exotoolbox.utils import pipe_data
import plotstyles
import os

# ------------------------------------------------------------------------------
#
#                 To plot CHEOPS subarray and imagette light curve
#
# ------------------------------------------------------------------------------
...
tab = pipe_data('Ch3/Fig33/KELT-20_401_sa.fits')

tim = (tab['TIME'] - tab['TIME'][0])*24
fl, fle = tab['FLUX'] / np.nanmedian(tab['FLUX']), tab['FLUX_ERR'] / np.nanmedian(tab['FLUX'])
...
#plt.show()
plt.savefig('Ch3/Fig33/kelt20_pipesa.pdf')#, dpi=250)
...
tab = pipe_data('Ch3/Fig33/KELT-20_401_im.fits')
